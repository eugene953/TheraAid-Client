    ...
    return (
     ...
     resizeMode='cover'
        ...
        >
            ...
            <Animated.Text style={styles.title} entering={FadeInRight.delay(300).duration(300).springify()}>Mental Health Support</Animated.Text>
            <Animated.Text style={styles.description} entering={FadeInRight.delay(500).duration(300)}>Get support and resource to improve your mental well-bieng.</Animated.Text>
            </View>
